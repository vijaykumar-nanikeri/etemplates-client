...
export enum PASSWORD_FORM_CONTROL_LABELS {
  ...
  PatternInstruction = 'Characters Allowed: Case-insensitive, Numbers, Special (<code>!</code>, <code>#</code>, <code>$</code>, <code>^</code>, <code>*</code>, <code>_</code>, <code><</code>, <code>></code> only)',
